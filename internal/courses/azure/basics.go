	...
	problems.RegisterAzureModules([]problems.CourseModule{
		{
			...
			Lessons: []problems.Lesson{
				{
					Title: "What is Azure?",
					Content: `Microsoft Azure is a comprehensive cloud computing platform provided by Microsoft. It offers a wide range of cloud services including computing power, storage, databases, networking, and more.
...
- **Security**: Azure Active Directory, Key Vault, Security Center, Azure Policy
- **Management**: Azure Monitor, Azure Resource Manager, Azure Automation
...
New-AzStorageAccount \\
    ...
    -SkuName Standard_LRS`,
				},
				{
					...
					Content: `Azure operates a global infrastructure designed for high availability, low latency, and scalability.

**Azure Infrastructure Components:**
- **Regions**: Geographic areas with multiple Availability Zones
- **Availability Zones**: Isolated data centers within a region
- **Edge Locations**: Points of presence for Azure CDN and Azure Front Door
