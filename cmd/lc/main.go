...
func main() {
	...
	mux.HandleFunc("/algorithms/test", handlers.HandleCourseTest)
	...
	mux.HandleFunc("/software-architecture/test", handlers.HandleCourseTest)
	...
	mux.HandleFunc("/aws/test", handlers.HandleCourseTest)
	mux.HandleFunc("/aws/", handlers.HandleAWSModule)
	mux.HandleFunc("/azure", handlers.HandleAzureCourse)
	mux.HandleFunc("/azure/test", handlers.HandleCourseTest)
	...
	mux.HandleFunc("/computer-architecture/test", handlers.HandleCourseTest)
